package com.leejean79.jvptree;

import com.leejean79.jvptree.util.*;
...
//            根据 qP 与 vP 的距离，将"partition&True"or"partition&False" 插入到partitions
//            给定一个查询点，可以通过在树中进行递归搜索来找到最近邻的数据点
